let aboutimage = './assets/images/Tinyiko.jpg';
 ...
 let worklist = 'COMPANY: Eldos Womens Imbokodo <br> POSITION: Software Development Intern <br> DUTIES: Designed and implemented an Android application in a 4-person team using Java in a 9 months Internship. <br><br> COMPANY: The Digital Academy <br> POSITION: Software Development Intern <br> DUTIES: Designed and implemented an Android application in a 5-person team using Ionic 4 and Firebase in a 6 months Internship. <br><br> COMPANY: Coralite Training Academy <br> POSITION: Software Development Intern <br> DUTIES: Designed and implemented CRUD Application using C# and ASP.net mvc 4.';
